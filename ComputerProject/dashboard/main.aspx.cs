...
namespace ComputerProject.dashboard
{
    public partial class index : System.Web.UI.Page
    {
        ...
        private void student_sync_data()
        {
            ...
            addLogs("<h4 class = 'font-thai font-2d0'>หัวข้อ</h4>", "<h4 class = 'font-thai font-1d8'>วันที่</h4>");
            ...
            string thinkspeak = getServiceResult("https://api.thingspeak.com/update?key=KTSF12TFPGZ2092S&field1=" + _jsonRecieveMes2.state);
        }
        ...
        {
            Response.Write(stg);
            string jsonRecieveMes = getServiceResult("http://localhost:55713/ServiceSave.svc/approveProject?project_temp=" + stg + "&state=4&status=1");
            dynamic _jsonRecieveMes = JsonConvert.DeserializeObject(jsonRecieveMes);
